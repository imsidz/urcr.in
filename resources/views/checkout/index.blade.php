                        ...
                        <div class="col-md-6 col-sm-6 col-ms-12">
                            <div class="check-billing">
                                <form class="form-my-account" action="/checkout" method="POST">
                                    ...
                                    <p>
                                        <input type="checkbox" name="save" id="remember" /> <label for="remember">Save
                                            this address for future</label>
                                    </p>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-ms-12">
                        ...
                        <div class="woocommerce-checkout-payment" id="payment">
                            <ul class="payment_methods methods list-none">
                                ...
                                <li class="payment_method_cod">
                                    <input type="radio" data-order_button_text="" checked value="cod"
                            ...
                            <div class="form-row place-order">
                                <input type="submit" data-value="Place order" value="Place order" id="place_order"
                                    name="woocommerce_checkout_place_order" class="button alt bg-color">
                            </div>
                            </form>
