...
export default {
    ...
    data() {
        return {
            ...
            dropzoneOptions: {
                url: `/api/child-category/image-upload`,
                thumbnailWidth: 150,
                maxFilesize: 2,
    ...
    methods: {
        ...
        createChildCategory() {
            axios.get("/admin/create-child-category").then(response => {
                this.form.child = response.data.id;
                this.dropzoneOptions.params.child = response.data.id;
            });
        },
        selectCategory() {
            axios
        ...
        submitForm() {
            axios
                .post("/admin/childcategory/create", this.form)
                .then(response => {
                    Swal.fire({
                        title: "Hurrey",
                        ...
                        window.location.href = "/admin/childcategory";
                    });
                });
        }
    }
